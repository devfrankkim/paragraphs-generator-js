...
form.addEventListener("submit", (e) => {
  ...
  if (isNaN(value) || value <= 0 || value > 9) {
    alertMessage.innerHTML = `<p class="alert-message">Only available between 1 ~ 9 <br> or <br>you will get a random paragraph</p>`;
    result.innerHTML = `<p class="result">${text[random]}</p>`;
  } else {
    alertMessage.innerHTML = "";
    // result.innerHTML = `<p class="result">${text[value - 1]}</p>`;
